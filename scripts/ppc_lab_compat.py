...
def macro_versions(root:Path)->dict[str,int]:
    ...
    out={}
    for key,macro in [('cpp_api','PPCLAB_CPP_API_VERSION'),('cpp_abi','PPCLAB_CPP_ABI_VERSION'),('target_profile_api','PPCLAB_TARGET_PROFILE_API_VERSION'),('release_api','PPCLAB_RELEASE_API_VERSION'),('compatibility_api','PPCLAB_COMPATIBILITY_API_VERSION')]:
