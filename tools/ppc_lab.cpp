...
int commandCapabilities(int argc, char** argv) {
    ...
    if (json) {
        std::cout << "{\n"
                  ...
                  << "  \"api\": {\"cpp\": 1, \"abi\": 1, \"target_profile\": 1, \"release\": 1, \"compatibility\": 1, \"observability\": 1, \"security\": 1, \"replication\": 1},\n"
                  << "  \"backends\": {\"builtin\": true, \"unicorn\": " << (unicorn ? "true" : "false") << "},\n"
                  << "  \"protocols\": {\"job\": \"ppc-lab-job-v1\", \"worker_response\": \"ppc-lab-worker-response-v1\", \"stream\": \"ndjson\", \"orchestration\": \"ppc-lab-orchestration-v1\", \"orchestration_job_result\": \"ppc-lab-orchestration-job-result-v1\", \"orchestration_summary\": \"ppc-lab-orchestration-summary-v1\", \"fleet\": \"ppc-lab-fleet-v1\", \"fleet_job_result\": \"ppc-lab-fleet-job-result-v1\", \"fleet_summary\": \"ppc-lab-fleet-summary-v1\", \"evidence_query\": \"ppc-lab-evidence-query-v1\", \"evidence_report\": \"ppc-lab-evidence-report-v1\", \"evidence_verify\": \"ppc-lab-evidence-verify-v1\", \"http_api\": \"ppc-lab-http-api-v1\", \"trace\": \"ppc-lab-trace-v1\", \"trace_analysis\": \"ppc-lab-trace-analysis-v1\", \"trace_diff\": \"ppc-lab-trace-diff-v1\", \"corpus_case\": \"ppc-lab-corpus-case-v1\", \"corpus_replay\": \"ppc-lab-corpus-replay-summary-v1\", \"differential_triage\": \"ppc-lab-differential-triage-v1\", \"triage_bundle\": \"ppc-lab-triage-bundle-v1\", \"exploration\": \"ppc-lab-exploration-v1\", \"exploration_case\": \"ppc-lab-exploration-case-v1\", \"exploration_summary\": \"ppc-lab-exploration-summary-v1\", \"campaign\": \"ppc-lab-campaign-v1\", \"campaign_state\": \"ppc-lab-campaign-state-v1\", \"campaign_summary\": \"ppc-lab-campaign-summary-v1\", \"campaign_triage_summary\": \"ppc-lab-campaign-triage-summary-v1\", \"priority_policy\": \"ppc-lab-priority-policy-v1\", \"priority_report\": \"ppc-lab-priority-report-v1\", \"scheduler\": \"ppc-lab-scheduler-v1\", \"scheduler_state\": \"ppc-lab-scheduler-state-v1\", \"scheduler_summary\": \"ppc-lab-scheduler-summary-v1\", \"control\": \"ppc-lab-control-v1\", \"control_item\": \"ppc-lab-control-item-v1\", \"control_telemetry\": \"ppc-lab-control-telemetry-v1\", \"control_history\": \"ppc-lab-control-history-v1\", \"control_history_record\": \"ppc-lab-control-history-record-v1\", \"knowledge_query\": \"ppc-lab-knowledge-query-v1\", \"knowledge_report\": \"ppc-lab-knowledge-report-v1\", \"knowledge_related\": \"ppc-lab-knowledge-related-v1\", \"knowledge_path\": \"ppc-lab-knowledge-path-v1\", \"knowledge_verify\": \"ppc-lab-knowledge-verify-v1\", \"hypothesis_report\": \"ppc-lab-hypothesis-report-v1\", \"hypothesis_experiment\": \"ppc-lab-hypothesis-experiment-v1\", \"hypothesis\": \"ppc-lab-hypothesis-v1\", \"platform_status\": \"ppc-lab-platform-status-v1\", \"upgrade_report\": \"ppc-lab-upgrade-report-v1\", \"acceptance_report\": \"ppc-lab-acceptance-report-v1\", \"target_profile\": \"ppc-lab-target-profile-v1\", \"target_profile_package\": \"ppc-lab-target-profile-package-v1\", \"release_manifest\": \"ppc-lab-release-manifest-v1\", \"release_qualification\": \"ppc-lab-release-qualification-v1\", \"release_certification\": \"ppc-lab-release-certification-v1\", \"compatibility_snapshot\": \"ppc-lab-compatibility-snapshot-v1\", \"support_report\": \"ppc-lab-support-report-v1\", \"support_bundle\": \"ppc-lab-support-bundle-v1\", \"deployment\": \"ppc-lab-deployment-v1\", \"deployment_report\": \"ppc-lab-deployment-report-v1\", \"backup\": \"ppc-lab-backup-v1\", \"backup_report\": \"ppc-lab-backup-report-v1\", \"upgrade_plan\": \"ppc-lab-upgrade-plan-v1\", \"upgrade_transaction\": \"ppc-lab-upgrade-transaction-v1\", \"release_channel\": \"ppc-lab-release-channel-v1\", \"observation\": \"ppc-lab-observation-v1\", \"observability_report\": \"ppc-lab-observability-report-v1\", \"observability_check\": \"ppc-lab-observability-check-v1\", \"capacity_report\": \"ppc-lab-capacity-report-v1\", \"auth_store\": \"ppc-lab-auth-store-v1\", \"audit_record\": \"ppc-lab-audit-record-v1\", \"replication_store\": \"ppc-lab-replication-store-v1\", \"replication_bundle\": \"ppc-lab-replication-bundle-v1\", \"replication_receipt\": \"ppc-lab-replication-receipt-v1\", \"replication_status\": \"ppc-lab-replication-status-v1\", \"replication_verify\": \"ppc-lab-replication-verify-v1\"}\n"
                  << "}\n";
    } else {
        std::cout << "PPC Lab " << kVersion << '\n'
                  ...
                  << "protocol.trace=ppc-lab-trace-v1\n"
                  << "protocol.trace-analysis=ppc-lab-trace-analysis-v1\n"
                  << "protocol.trace-diff=ppc-lab-trace-diff-v1\n"
                  ...
                  << "protocol.campaign=ppc-lab-campaign-v1\n"
                  << "protocol.campaign-state=ppc-lab-campaign-state-v1\n"
                  << "protocol.campaign-summary=ppc-lab-campaign-summary-v1\n"
                  << "protocol.campaign-triage-summary=ppc-lab-campaign-triage-summary-v1\n"
                  << "protocol.priority-policy=ppc-lab-priority-policy-v1\n"
                  << "protocol.priority-report=ppc-lab-priority-report-v1\n"
                  << "protocol.scheduler=ppc-lab-scheduler-v1\n"
                  << "protocol.scheduler-state=ppc-lab-scheduler-state-v1\n"
                  << "protocol.scheduler-summary=ppc-lab-scheduler-summary-v1\n"
                  << "protocol.control=ppc-lab-control-v1\n"
                  << "protocol.control-item=ppc-lab-control-item-v1\n"
                  << "protocol.control-telemetry=ppc-lab-control-telemetry-v1\n"
                  << "protocol.control-history=ppc-lab-control-history-v1\n"
                  << "protocol.control-history-record=ppc-lab-control-history-record-v1\n"
                  << "protocol.knowledge-query=ppc-lab-knowledge-query-v1\n"
                  << "protocol.knowledge-report=ppc-lab-knowledge-report-v1\n"
                  << "protocol.knowledge-related=ppc-lab-knowledge-related-v1\n"
                  << "protocol.knowledge-path=ppc-lab-knowledge-path-v1\n"
                  << "protocol.knowledge-verify=ppc-lab-knowledge-verify-v1\n"
                  << "protocol.hypothesis-report=ppc-lab-hypothesis-report-v1\n"
                  << "protocol.hypothesis-experiment=ppc-lab-hypothesis-experiment-v1\n"
                  << "protocol.hypothesis=ppc-lab-hypothesis-v1\n"
                  << "protocol.platform-status=ppc-lab-platform-status-v1\n"
                  << "protocol.upgrade-report=ppc-lab-upgrade-report-v1\n"
                  << "protocol.acceptance-report=ppc-lab-acceptance-report-v1\n"
                  << "protocol.target-profile=ppc-lab-target-profile-v1\n"
                  << "protocol.target-profile-package=ppc-lab-target-profile-package-v1\n"
                  << "protocol.release-manifest=ppc-lab-release-manifest-v1\n"
                  << "protocol.release-qualification=ppc-lab-release-qualification-v1\n"
                  << "protocol.release-certification=ppc-lab-release-certification-v1\n"
                  << "protocol.compatibility-snapshot=ppc-lab-compatibility-snapshot-v1\n"
                  << "protocol.observation=ppc-lab-observation-v1\n"
                  << "protocol.observability-report=ppc-lab-observability-report-v1\n"
                  << "protocol.observability-check=ppc-lab-observability-check-v1\n"
                  << "protocol.capacity-report=ppc-lab-capacity-report-v1\n"
                  << "protocol.auth-store=ppc-lab-auth-store-v1\n"
                  << "protocol.audit-record=ppc-lab-audit-record-v1\n"
                  << "protocol.replication-store=ppc-lab-replication-store-v1\n"
                  << "protocol.replication-bundle=ppc-lab-replication-bundle-v1\n"
                  << "protocol.replication-receipt=ppc-lab-replication-receipt-v1\n"
                  << "protocol.replication-status=ppc-lab-replication-status-v1\n"
                  << "protocol.replication-verify=ppc-lab-replication-verify-v1\n"
                  << "api.cpp=1\napi.abi=1\napi.target-profile=1\napi.release=1\napi.compatibility=1\napi.observability=1\napi.security=1\napi.replication=1\n";
    }
    return 0;
}
...
int commandDoctor(int argc, char**) {
    ...
    std::cout << "intake=ELF32-PPC-BE,Mach-O-PPC32-BE,PEF-CFM-PPC,raw\n"
              ...
              << "mature-platform=ppc-lab-platform\nstatus=PASS\n";
    return 0;
}
