...
def main()->int:
    cur=mod.build_snapshot(ROOT); assert cur['platform_version']=='3.9.2'; assert cur['compatibility_api']==1 and cur['replication_api']==1
    assert 'ppc-lab-compat' in cur['installed_tools'] and 'ppc-lab-replicate' in cur['installed_tools']; assert 'ppc-lab-compatibility-snapshot-v1.schema.json' in cur['schemas'] and 'ppc-lab-release-qualification-v1.schema.json' in cur['schemas'] and 'ppc-lab-replication-bundle-v1.schema.json' in cur['schemas']
