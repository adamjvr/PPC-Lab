...
with tempfile.TemporaryDirectory(prefix='ppclab-release-') as raw:
    ...
    assert doc['schema']=='ppc-lab-release-manifest-v1' and doc['version']=='3.9.1'
    assert doc['compatibility']['schema']=='ppc-lab-compatibility-snapshot-v1' and doc['compatibility']['platform_version']=='3.9.1'
    ...
    with zipfile.ZipFile(a) as zf:
        ...
        assert embedded['version']=='3.9.1' and embedded['schema']=='ppc-lab-release-manifest-v1'
        assert embedded['compatibility']['platform_version']=='3.9.1'
